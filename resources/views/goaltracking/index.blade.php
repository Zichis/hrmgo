                                    ...
                                    <td>
                                        <div class="progress-wrapper">
                                            ...
                                            <div class="progress progress-xs mt-2 w-100">
                                                <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{$goalTracking->progress}}" aria-valuemin="0" aria-valuemax="100" style="width: {{$goalTracking->progress}}%;"></div>
                                            </div>
                                        </div>
