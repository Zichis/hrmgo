...
class AccountList extends Model
{
    ...
    {
        $accountBalance = \App\AccountList::where('id', '=', $id)->first();
    ...
    {
        $fromAccount = \App\AccountList::where('id', '=', $from_account)->first();
        $fromAccount->initial_balance = $fromAccount->initial_balance - $amount;
        $fromAccount->save();
        $toAccount = \App\AccountList::where('id', '=', $to_account)->first();
